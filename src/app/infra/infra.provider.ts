...
import { GetTodoItemEvents, TodoListGateway, UpdateTodoItemGateway } from "./todo-list/todo-list.gateway";
...
export function infraProviders() {
    ...
    const todoListService = new InMemoryTodoListService(items, 3000);
